...
for i in range(n):
	c = int(input("Enter traffic density: "))
	arr.append(c)
...
for i in range(n):
	if i == 0 :
		...
		if arr[i]>=arr[i-1] and arr[i]>=arr[i+1]:
			...
			pro = pro*arr[i]
if p :
	print("Peak traffic density:",p)
	print("Sum of traffic density:",sum)
	print("Sum of traffic density:",pro)
	s = sorted(p)
	print("Maximum peak traffic density:",s[-1])
else:
