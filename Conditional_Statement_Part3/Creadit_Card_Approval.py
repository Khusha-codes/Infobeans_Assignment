...
employment = input("Enter Employment Type (government/private): ").lower()
debt = int(input("Enter Existing Debt: "))

if income >= 50000:
    if credscore >= 750:
        if debt < 20000:
            print("Credit Card = Premium Card ")
        else:
            print("Credit Card = Gold Card ")
    else:
        if employment == "government" and creditscore >= 650:
            print("Credit Card = Gold Card ")
        else:
            print("Credit Card = Rejected")

else:
    if income >= 30000 and credscore >= 700:
        print("Credit Card = Silver Card ")
    else:
        print("Credit Card = Rejected")